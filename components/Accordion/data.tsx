import { AccordionDatum } from './interfaces'
import { Avatar } from '@/components/AvatarGroup/index'
import { 
  CookieIcon, 
  MoonIcon, 
  RocketIcon,
...
export const accordionData: AccordionDatum[] = [
    {
...
export const accordionData2: AccordionDatum[] = [
  {
    prefix: <BackpackIcon />,
