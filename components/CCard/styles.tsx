        ...
        variant: {
            interactive: {
                '&:hover': {
                    ...
                    boxShadow: '0 2px 1px 2px $$shadowColor',
                },
                '&:focus': {
                    '&::before': {
...
export type CardProps = React.ComponentProps<typeof StyledCard> & { as?: 'button' | 'div' }
export const Card = React.forwardRef<HTMLDivElement, CardProps>(
    ({ children, as, ...props }, forwardedRef) => (
        <StyledCard {...props} as={as} ref={forwardedRef}>
            {children}
        </StyledCard>
    )
)
