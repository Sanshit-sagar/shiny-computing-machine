...
const sharedColors = {
    ...
    dangerBase: '$crimson1',
    dangerBgSubtle: '$crimson2',
    dangerBg: '$crimson3',
    dangerBgHover: '$crimson4',
    dangerBgActive: '$crimson5',
    dangerLine: '$crimson6',
    dangerBorder: '$crimson7',
    dangerBorderHover: '$crimson8',
    dangerSolid: '$crimson9',
    dangerSolidHover: '$crimson10',
    dangerSolidActive: '$crimson10',
    dangerText: '$crimson11',
    dangerTextContrast: '$crimson12',
    dangerFocusRing: '$crimson8',
...
export const {
    ...
    media: {
        ...
        motion: '(prefers-crimsonuced-motion)',
